  ...
  <div class="container h-100 py-5">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      @if(!empty($cartProduct))
        ...
        @endif
          <a class="btn btn-success" href="{{route('order.now')}}">Order Now</a>
          <table class="table">
            <thead>
              <tr>
              ...
              <tr>
                <th scope="row">
                  <div class="d-flex align-items-center">
                    <img src="{{$product->gallery}}" class="img-fluid rounded-3"
                ...
                <td class="align-middle">
                  <a href="{{route('remove.product', $product->cart_id)}}" ><button class="btn btn-warning">Remove from cart</button></a>
                </td>
